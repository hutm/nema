...
public class BeatEvaluationIntegrationTest extends BaseManagerTestCase {
	...
	public static final String GT_PATH = "src/test/resources/beat/groundtruth";
	public static final String RESULT_PATH = "src/test/resources/beat/results";
